-- Configuración inicial para MySQL 5.7
...
CREATE DATABASE IF NOT EXISTS `test_posgrados_ubosque` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `test_posgrados_ubosque`;
...
-- Volcado de datos para la tabla `Formacion`  -- ¿Qué posgrado quieres hacer? -- Este no estatico 
...
CREATE TABLE `linea_conocimiento` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(10, 'Humanidades'),
(11, 'Odontología');
-- Volcado de datos para la tabla `linea_conocimiento` -- No es estatico
CREATE TABLE `modalidad` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `modalidad` varchar(140) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- Volcado de datos para la tabla `modalidad` -- No estatico
...
CREATE TABLE `programa` (
  ...
  `formacion` int(11) NOT NULL, -- Maestría postgrado
  `modalidad` int(11) NOT NULL, -- presencial, virtual
  `linea_conocimiento` int(11) NOT NULL, -- carrera
