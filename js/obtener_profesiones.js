        ...
        if (result.success) {
            ...
            profesiones.forEach(profesion => {
                ...
                customOption.addEventListener('click', () => {
                    ...
                    // Guardar ID de profesión seleccionada
                    window.selectedProfesionId = profesion.id;
                    localStorage.setItem('selectedProfesionId', profesion.id);
                    console.log('Profesión seleccionada - ID:', profesion.id, 'Nombre:', profesion.linea);
